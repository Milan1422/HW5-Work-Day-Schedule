...
// Input today's date for the schedule
let DateTime = luxon.DateTime;
let now = DateTime.local();
currentDay.textContent = now.toLocaleString(DateTime.DATE_HUGE)

// Time display under today's date
setInterval(() => {
    let currentHour = DateTime.local();
    currentTime.textContent = currentHour.toLocaleString(DateTime.TIME_24_WITH_SECONDS)
}, 1000);